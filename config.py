...
DEFAULT_CONFIG = [
    ...
    },
    {
        ...
        FileType.ATTR_TYPE:FileType.ONLINE,
        FileType.ATTR_DESC:"GTNH依赖",
        FileType.ATTR_URL:"https://github.com/GTNewHorizons/CodeChickenLib/releases/download/1.2.0//CodeChickenLib-1.2.0.jar",
        FileType.ATTR_SP:"mods",
        FileType.ATTR_VERSION_DEMAND:["2.6.0","2.6.1"]
    },
    {
        FileType.ATTR_ENABLED:True,
        FileType.ATTR_TYPE:FileType.ONLINE,
